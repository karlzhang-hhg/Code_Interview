# Runtime: 620 ms, faster than 88.78% of Python3 online submissions for Longest Arithmetic Subsequence of Given Difference.
# Memory Usage: 26 MB, less than 100.00% of Python3 online submissions for Longest Arithmetic Subsequence of Given Difference.
# Very simple and clean, O(n), use value instead of index as dp state.
...
class Solution:
    def longestSubsequence(self, arr: List[int], difference: int) -> int:
        ...
        for v in arr:
            pre_v = v-difference
            tmp=m_vl[v]=1+m_vl[pre_v] if pre_v in m_vl else 1
            res = max(res, tmp)
        return res
